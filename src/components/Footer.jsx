      ...
      <div className="flex justify-around mt-[68px]">
        <div className=" text-white">
          ...
          <p className="text-[16px]">
            Lorem ipsum dolor sit amet consectetur. Mauris arcu vulputate
            <br />
            ipsum ac pretiumest laoreet porta sed.
          </p>
          <p className=" text-[48px] mt-20 font-medium">Ask Us Anything</p>
          <div className="flex mt-8 items-center justify-between">
            <div className="w-[550px] border-b-[2px] border-b-white1 flex justify-between">
              <input
                type="text"
                className="bg-orange text-[24px] placeholder-white "
                placeholder="Your Message"
              />
              <div className="h-14 w-14 m-2 flex justify-between bg-blue p-4 rounded-full">
